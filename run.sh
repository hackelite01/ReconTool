#!/bin/bash
# This script was coded by @NonRootedInsaan
# Please give me credits if you us any codes from here.
# Telegram Group: http://t.me/hackelite02
...
banner() {
printf "\n\e[1;92m"
printf "\n\e[1;92m   ___                  ______          __"
printf "\n\e[1;92m  / _ \___ _______  ___/_  __/__  ___  / /"
printf "\n\e[1;92m / , _/ -_) __/ _ \/ _ \/ / / _ \/ _ \/ / "
printf "\n\e[1;92m/_/|_|\__/\__/\___/_//_/_/  \___/\___/_/  
                                          
1;95mv1.8-BETA\n"
printf "\n\e[1;92m   Coded by \e[1;94m@hackelite01\n\n\e[1;92m"
}
dependencies() {
...
if [[ $option == 1 || $option == 01 ]]; then
	...
	printf "\n\n\e[1;92m Join Telegram Group for feedback:\e[1;96m http://t.me/hackelite02\e[1;92m\n"
	exit 1
